...
const handleClickAction = (row, t) => {
  ...
  if(t === 'template'){
    initDownloadExcel([
      ['谱名', '姓氏', '堂号', '出版年', '公元年', '谱籍地', '作者', '作者职务', '始迁祖', '先祖名人', '版本类型', '总卷数', '缺卷说明', '单双页', '实拍册数', '影像页', '说明', '馆藏地', '入库编号'],
      ['甬東包氏支譜', '包', '尊樂堂', '（清）光緒四年', '1878', '浙江省,宁波市,鄞州区', '不详', '编纂', '榮', '業，為一世祖。拯，字希仁，諡孝肅，宋朝人，龍圖閣大學士，為五世祖。', '刻本', '3卷', '0', '单', '3', '289', '世系修錄至第三十五世', '鄞州圖書館', '7001'],
      ['必填', '必填', '必填(可填 无)', '非必填', '非必填', '必填', '必填(可填 不详)', '必填(可填 不详)', '非必填', '非必填', '必填(可填 刻本、刊本、写本)', '必填', '非必填', '必填', '必填', '非必填', '非必填', '非必填', '非必填'],
    ], '鄞州图书馆谱目表头');
  }
  if(t === 'batchLoad'){
